...
# Usage: ./scripts/generate_cli_docs_unified.sh <cli_name> [output_dir]
#
# Examples:
#   ./scripts/generate_cli_docs_unified.sh aztec
#   ./scripts/generate_cli_docs_unified.sh aztec-wallet /tmp
...
python3 "$SCRIPT_DIR/generate_cli_docs.py" --command "$COMMAND" --output "$JSON_FILE"
...
echo "  python3 $SCRIPT_DIR/generate_cli_docs.py --help"
echo "  python3 $SCRIPT_DIR/transform_cli_docs.py --help"
