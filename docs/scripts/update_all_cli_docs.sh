...
# Usage: ./scripts/update_all_cli_docs.sh [target_version]
#
# Examples:
#   ./scripts/update_all_cli_docs.sh                    # Updates all versions
#   ./scripts/update_all_cli_docs.sh v2.0.2             # Updates only v2.0.2
#   ./scripts/update_all_cli_docs.sh current            # Updates only main docs folder
...
for cli in "${CLIS[@]}"; do
  ...
  "$SCRIPT_DIR/update_cli_docs_unified.sh" "$cli" "$TARGET_VERSION"
