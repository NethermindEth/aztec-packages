...
description: Comprehensive auto-generated reference for the Aztec command-line interface (CLI) with all commands and options.
...
:::info
This is an auto-generated reference. For a more curated guide with examples and best practices, see the [manual CLI reference](./cli_reference.md).
:::


*Generated: Fri Oct 24 00:56:10 HKT 2025*
...
- [aztec](#aztec)
  ...
  - [aztec bootstrap-network](#aztec-bootstrap-network)
  ...
  - [aztec drip-faucet](#aztec-drip-faucet)
...
```
Usage: aztec drip-faucet [options]

Drip the faucet

Options:
  -u, --faucet-url <string>  Url of the faucet (default:
                             "http://localhost:8082")
  -t, --token <string>       The asset to drip (default: "eth")
  -a, --address <string>     The Ethereum address to drip to
...
- `--snapshots-url <value>`
  ...
  *Environment: `$SYNC_SNAPSHOTS_URL`*
...
- `--rollup-version <value>` (default: `canonical`)
...
- `--sequencer.l1PublishRetryIntervalMS <value>` (default: `1000`)
  The interval to wait between publish retries.
  *Environment: `$SEQ_PUBLISH_RETRY_INTERVAL_MS`*
...
- `--proverNode.l1PublishRetryIntervalMS <value>` (default: `1000`)
  The interval to wait between publish retries.
  *Environment: `$PROVER_PUBLISH_RETRY_INTERVAL_MS`*
...
Arguments:
  projectPath               Path to the project directory (default:
                            "/Users/aztec/code/aztec-packages")
