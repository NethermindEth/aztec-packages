...
import type { ClientIvcProofWithPI } from '@aztec/stdlib/proofs';
...
export abstract class BBPrivateKernelProver implements PrivateKernelProver {
  ...
  public createClientIvcProof(_executionSteps: PrivateExecutionStep[]): Promise<ClientIvcProofWithPI> {
