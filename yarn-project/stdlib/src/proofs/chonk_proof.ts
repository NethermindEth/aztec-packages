...
export class ChonkProof {
  ...
  static random(proofSize = CHONK_PROOF_LENGTH) {
  ...
  // Called when constructing a ChonkProof from proving results.
  static fromBufferArray(fields: Uint8Array[]): ChonkProof {
