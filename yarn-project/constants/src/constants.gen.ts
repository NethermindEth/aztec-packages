...
export const L1_TO_L2_MSG_SUBTREE_ROOT_SIBLING_PATH_LENGTH = 32;
...
export const CHECKPOINT_HEADER_LENGTH = 10;
export const CHECKPOINT_HEADER_SIZE_IN_BYTES = 252;
...
export const CHECKPOINT_ROLLUP_PUBLIC_INPUTS_LENGTH = 194;
