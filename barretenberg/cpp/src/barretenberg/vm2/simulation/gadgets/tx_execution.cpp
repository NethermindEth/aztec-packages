...
void TxExecution::insert_non_revertibles(const Tx& tx)
{
    ...
    contract_db.add_non_revertible_contracts(tx.nonRevertibleContractDeploymentData);
}
...
void TxExecution::insert_revertibles(const Tx& tx)
{
    ...
    contract_db.add_revertible_contracts(tx.revertibleContractDeploymentData);
}
