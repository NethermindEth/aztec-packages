...
void HintedRawContractDB::add_non_revertible_contracts([[maybe_unused]] const ContractDeploymentData& deployment_data)
{
    debug("add_non_revertible_contracts called (no-op in hinted mode)");
}

void HintedRawContractDB::add_revertible_contracts([[maybe_unused]] const ContractDeploymentData& deployment_data)
{
