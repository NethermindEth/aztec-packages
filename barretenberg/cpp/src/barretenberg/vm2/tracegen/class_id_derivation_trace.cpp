    ...
    for (const auto& event : events) {
        trace.set(row,
                  { {
                      ...
                      { C::class_id_derivation_private_function_root, event.klass.private_functions_root },
                      ...
                      { C::class_id_derivation_gen_index_contract_leaf, GENERATOR_INDEX__CONTRACT_LEAF },
