...
void TranslatorCircuitBuilder::feed_ecc_op_queue_into_circuit(const std::shared_ptr<ECCOpQueue>& ecc_op_queue)
{
    ...
    // The position and number of these random ops are explained in ClientIVC::hide_op_queue_content_tail_kernel
    // and ClientIVC::hide_op_queue_content_hiding_kernel
